    ...
    for (const inv in inventario_tienda) {
        ...
        if (producto.nombre === nombre) {
            if (producto.cantidad >= cantidad) {
                ...
                console.log(`Venta realizada exitosamente!: ${cantidad} ${nombre}. Quedan ${producto.cantidad} en stock.`);
                return;
            } else {
                console.log(`Error al realizar la compra: Stock insuficiente para ${nombre}!`);
                return;
            }
        }
    }
    console.log(`Error al realizar la compra: El producto ${nombre} no existe en el inventario!`);
}
